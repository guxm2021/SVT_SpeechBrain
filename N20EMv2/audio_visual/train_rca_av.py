    ...
    def compute_objectives(self, predictions, batch, stage):
        ...
        if stage != sb.Stage.TRAIN:
            ...
            if cur_utter == all_utter:
                ...
                if add_noise:
                    pred_save_path = os.path.join(pred_save_folder, noise_type, f"SNR_{snr_db}dB_av_pred.npy")
                else:
                    pred_save_path = os.path.join(pred_save_folder, "clean_av_pred.npy")
...
def dataio_prepare(hparams):
    ...
    sb.dataio.dataset.set_output_keys(
        datasets,
        ["id", "audio", "sig1", "sig2", "anno", "cur_utter", "all_utter", "ref_intervals", "ref_pitchs"],
    )
